// frontend/src/app/page.tsx - Advanced EdTech Homepage
"use client";
...
export default function HomePage() {
  ...
  const fetchStats = async () => {
    try {
      // Mock stats for now - you can replace with real API
      setStats({
        totalCourses: featuredCourses.length || 15,
        totalStudents: 1250,
        totalModules: 180,
        completionRate: 94
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0b14] via-[#0e0f1a] to-[#1a0e2e] text-white overflow-hidden">
      {/* Background Effects */}
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/shop/bundles" className="text-gray-300 hover:text-white transition-colors">Bundles</Link>
              <Link href="/bundles" className="text-gray-300 hover:text-white transition-colors">My Bundles</Link>
              <Link href="/login" className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors">Login</Link>
              <Link href="/register" className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg font-semibold transition-all">
                Get Started
              </Link>
            </div>
          </div>
